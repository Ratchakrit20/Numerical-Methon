...
export default class Gauss extends React.Component{
    constructor(props){
        super(props)
        this.state={
          x1:"",
        ...
        this.GaussMethon=this.GaussMethon.bind(this);
    ...
    GaussMethon(x1,x2,x3){
        ...
        while(data.count < 30){
            ...
            data.x2 = (this.state.b2 - this.state.a21*data.x1 -this.state.a23*x3)/this.state.a22;
            data.x3 = (this.state.b3 - this.state.a31*data.x1 -this.state.a32*data.x2)/this.state.a33;
        ...
        var datachart = {
          ...
          "layout": {  
                       ...
                       "yaxis": { title: "ERROR"},
                       "title": "Gauss-seidel Iteration graph"}
    ...
    render(){
      ...
      let rows=this.state.Arr1.map(x =>{return <DataRow key={x.count} data={x}/>});
        return(
          ...
          <div className='head'>
            <div >
              <h1>&emsp;Gauss-seidel Iteration Method&emsp;</h1>
